...
print("Bomavgift elbil per år: 0.1 kr * 10000 km")
...
print("Drivstofforbruk bensinbil per år:1.0 kr * 10000 km")
kostnader_bomavgift_bensinbil = 0.2 * årlig_kjørelengde_bensinbil #kr/km
print("Bomavgift bensinbil per år:0,2 * 10000 km")
